            ...
            <div role="tabpanel"
                ...
                <div class="row">
                    ...
                    <div
                        ...
                        <?php
                            $value = (isset($client) ? $client->company_pan : '');
                            echo render_input('company_pan', 'Company PAN', $value);
                        ?>
                        <?php $value = (isset($client) ? $client->gst_type : '');?>
                        <div class="form-group select-placeholder">
                            <label for="gst_type" class="control-label">GST Type</label>
                            <select name="gst_type" id="gst_type" class="form-control selectpicker" data-none-selected-text="None selected">
                                <option value="">None selected</option>
                                <option value = "1" <?php if($value == "1"){ echo 'selected';}?>>Registered - Regular</option>
                                <option value = "2" <?php if($value == "2"){ echo 'selected';}?>>Un-Registered</option>
                                <option value = "3" <?php if($value == "3"){ echo 'selected';}?>>Registered - Composit</option>
                                <option value = "4" <?php if($value == "4"){ echo 'selected';}?>>Overseas</option>
                            </select>
                        </div>
