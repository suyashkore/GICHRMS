         ...
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <label><strong>Dynamic Section</strong></label>
                     <div class="col-md-12" id="show111">
<?php
$mycal_feild = $proposal->mycal_feild;
//echo $mycal_feild;
if(isset($mycal_feild)){
 //$php_var = "";
 echo html_entity_decode($proposal->mycal_feild);
}else
{
    $php_var5 = 'Based on our experience, we are highly confident we can meet or exceed your search traffic within the next <input type="text" name="text1" id="text1" class="text1" size="5" maxlength="4" value="" style="height:25px;"> months. To start with, well need to perform a SEO audit. As discussed, your goal is to work with <input type="text" name="text2" id="text2" size="5" value="" maxlength="4" style="height:25px;"> new customers within one year (average of <input type="text" name="text3" id="text3" size="5" maxlength="4" readonly style="height:25px;"> /month). At your current close rate of <input type="text" name="text4" value="10" id="text4" size="5" maxlength="4" style="height:25px;"> % , you’ll need to generate approximately <input type="text" name="text5" value="" id="text5" size="5" maxlength="4" style="height:25px;"> high quality leads per month, meaning that they reach the bottom of the funnel and become a sales qualified lead. If a “guesstimated” <input type="text" name="text6" value="" id="text6" size="5" maxlength="4" style="height:25px;">% of your leads move all the way through the buyer funnel, you’ll need to generate <input type="text" name="text7" value="" id="text7" size="5" maxlength="4" style="height:25px;"> top or middle of the funnel leads.';
 echo $php_var5;
...
<textarea rows="2" name="mycal_feild" id="mycal_feild" style="display: none;"><?php //echo $php_var; ?></textarea>
...
<script type="text/javascript">
 ...
 var value3 = parseInt(value2/value1);

  var value4 = $("#text4").val();

  var value5 = parseInt((value3/value4)*100);
  
  
    //$("#span1").text(text3);
    $("#text3").attr("value", value3);
    $("#text5").attr("value", value5);
    $("#text6").attr("value", value4);
    $("#text7").attr("value", value5);
    //var sss = '<?php echo $php_var; ?>';
    var sss = 'Based on our experience, we are highly confident we can meet or exceed your search traffic within the next <input type="text" name="text1" id="text1" class="text1" size="5" maxlength="4" value="'+value1+'" style="height:25px;"> months. To start with, well need to perform a SEO audit. As discussed, your goal is to work with <input type="text" name="text2" id="text2" size="5" value="'+value2+'" maxlength="4" style="height:25px;"> new customers within one year (average of <input type="text" name="text3" id="text3" size="5" maxlength="4" value="'+value3+'" readonly style="height:25px;"> /month). At your current close rate of <input type="text" name="text4" value="'+value4+'" id="text4" size="5" maxlength="4" style="height:25px;"> % , you’ll need to generate approximately <input type="text" name="text5" value="'+value5+'" id="text5" size="5" maxlength="4" style="height:25px;"> high quality leads per month, meaning that they reach the bottom of the funnel and become a sales qualified lead. If a “guesstimated” <input type="text" name="text6" value="'+value4+'" id="text6" size="5" maxlength="4" style="height:25px;">% of your leads move all the way through the buyer funnel, you’ll need to generate <input type="text" name="text7" value="'+value5+'" id="text7" size="5" maxlength="4" style="height:25px;"> top or middle of the funnel leads.';
    $("#mycal_feild").val(sss);
