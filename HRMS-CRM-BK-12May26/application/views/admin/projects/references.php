...
<?php echo form_open_multipart(admin_url('projects/upload_file_for_references/'.$project->id),array('class'=>'dropzone','id'=>'project-files-upload-for-references')); ?>
      ...
      <tr>
        ...
        <td data-order="<?php echo $file['file_name']; ?>">
         ...
         <td>
           ...
           <a href="<?php echo admin_url('projects/remove_file_for_referance/'.$project->id.'/'.$file['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
           <?php } ?>
         </td>
       </tr>
       <?php } ?>
