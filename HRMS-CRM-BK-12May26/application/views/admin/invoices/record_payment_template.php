    ...
    <div class="panel_s">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="TdsApplicable" class="control-label">Is TDS Applicable</label>
                        <select class="selectpicker" name="TdsApplicable" id="TdsApplicable" data-width="100%" data-none-selected-text="None selected">
                            <option value=""></option>
                ...
                <div class="col-md-6 tds_amount_html" style="display:none;">
                    <?= render_input('tds_amount', 'TDS Amt'); ?>
                </div>
                <div class="col-md-6">
...
if ($pr_template || $sms_trigger) { ?>
                    <div class="checkbox checkbox-primary mtop15">
                        <input type="checkbox" checked name="do_not_send_email_template" id="do_not_send_email_template">
...
<?= form_close(); ?>
<script>
    $('#TdsApplicable').on('change', function() {
        var tdsapplicable = $(this).val();
        if(tdsapplicable == "Y"){
             $(".tds_amount_html").css("display", "block");
        }else{
            $(".tds_amount_html").css("display", "none");
        }
    });
    $(function() {
        init_selectpicker();
