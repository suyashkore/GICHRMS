...
?>
                        <th width="12%" align="left" class="hsn">
                            HSN/SAC
                        </th>
                ...
                <tbody>
                    <tr class="main">
                        ...
                        <td>
                            <div class="form-group select-placeholder">
                                <select name="hsn_code" id="hsn_code" class="selectpicker hsn_code" data-width="100%" data-live-search = "true"
                                    data-none-selected-text="None selected">
                                    <option value =""></option>
                                    <option value="998313">998313</option>
                                    <option value="998314">998314</option>
                                    <option value="998361">998361</option>
                                </select>
                            </div>
                        </td>
...
?>
                    ...
                    <?php if (isset($invoice) || isset($add_items)) {
                        ...
                        foreach ($add_items as $item) {
                            ...
                            $table_row .= '<td> <div class="form-group select-placeholder">
                                <select name="' . $items_indicator . '[' . $i . '][hsn_code]" class="selectpicker hsn_code" data-width="100%" data-live-search = "true"
                                    data-none-selected-text="None selected">
                                    <option value =""></option>';
                                    if($item["hsn_code"] == "998313"){  $sel = "selected"; }
                                    $table_row .= '<option value="998313"'. $sel.'>998313</option>';
                                    if($item["hsn_code"] == "998314"){  $sel2 = "selected"; }
                                    $table_row .= '<option value="998314" '.$sel2.'>998314</option>';
                                    if($item["hsn_code"] == "998361"){  $sel3 = "selected"; }
                                    $table_row .= '<option value="998361" '.$sel3.'>998361</option>';
                                $table_row .= '</select>
                            </div> </td>';
