	...
	echo form_open_multipart(admin_url('recruitment/add_update_candidate'), array('id' => 'recruitment-candidate-form'));}?>
                  ...
                  <div class="col-md-7">
                    <div class="panel panel-primary">
                      <div class="panel-heading"><?php echo 'General Information'; // _l('general_information') ?></div>
                      <div class="panel-body">
...
echo render_textarea('introduce_yourself', 'introduce_yourself', $introduce_yourself)?>
                  ...
                  <div class="col-md-5">
                    <div class="panel panel-info">
                      <div class="panel-heading"><?php echo 'Contact Information';// _l('contact_information') ?></div>
                      <div class="panel-body">
