...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
    ...
    private static function checkSheetCodeName($pValue)
    {
        ...
        if ((new_str_replace(self::$invalidCharacters, '', $pValue) !== $pValue) ||
...
/**
    ...
    */
    public function setCodeName($pValue = null)
    {
        ...
        $pValue = new_str_replace(' ', '_', $pValue);//Excel does this automatically without flinching, we are doing the same
        // Syntax check
