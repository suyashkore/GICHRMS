...
class hr_payroll extends AdminController {
	...
	public function manage_employees() {
		...
		foreach ($staffs as $staff_key => $staff_value) {
			...
			if ($rel_type == 'hr_records') {
				...
				$data_object_kpi[$staff_key]['sex'] = $staff_value['sex'];
				$data_object_kpi[$staff_key]['birthday'] = $staff_value['birthday'];
				$data_object_kpi[$staff_key]['datecreated'] = date('Y-m-d', strtotime($staff_value['datecreated']));
				$data_object_kpi[$staff_key]['nation'] = $staff_value['nation'];
				$data_object_kpi[$staff_key]['passport_no'] = $staff_value['passport_no'];
				$data_object_kpi[$staff_key]['passport_expiry'] = $staff_value['passport_expiry'];
				$data_object_kpi[$staff_key]['emirates_ID_No'] = $staff_value['emirates_ID_No'];
				$data_object_kpi[$staff_key]['EID_expiry'] = $staff_value['EID_expiry'];
				$data_object_kpi[$staff_key]['labour_card_No'] = $staff_value['labour_card_No'];
				$data_object_kpi[$staff_key]['phonenumber'] = $staff_value['phonenumber'];
				$data_object_kpi[$staff_key]['contact_person_home_country'] = $staff_value['contact_person_home_country'];
				$data_object_kpi[$staff_key]['home_contact_No'] = $staff_value['home_contact_No'];
				$data_object_kpi[$staff_key]['other_contact_person'] = $staff_value['other_contact_person'];
				$data_object_kpi[$staff_key]['other_contact_No'] = $staff_value['other_contact_No'];
				$data_object_kpi[$staff_key]['visa_validity'] = $staff_value['visa_validity'];
			} else {
				if (isset($employees_value[$staff_value['staffid'] . '_' . $current_month])) {
					...
					$data_object_kpi[$staff_key]['designation'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['designation'];
					$data_object_kpi[$staff_key]['sex'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['sex'];
					$data_object_kpi[$staff_key]['birthday'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['birthday'];
					$data_object_kpi[$staff_key]['datecreated'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['datecreated'];
					$data_object_kpi[$staff_key]['nation'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['nation'];
					$data_object_kpi[$staff_key]['passport_no'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['passport_no'];
					$data_object_kpi[$staff_key]['passport_expiry'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['passport_expiry'];
					$data_object_kpi[$staff_key]['emirates_ID_No'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['emirates_ID_No'];
					$data_object_kpi[$staff_key]['EID_expiry'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['EID_expiry'];
					$data_object_kpi[$staff_key]['labour_card_No'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['labour_card_No'];
					$data_object_kpi[$staff_key]['phonenumber'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['phonenumber'];
					$data_object_kpi[$staff_key]['contact_person_home_country'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['contact_person_home_country'];
					$data_object_kpi[$staff_key]['home_contact_No'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['home_contact_No'];
					$data_object_kpi[$staff_key]['other_contact_person'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['other_contact_person'];
					$data_object_kpi[$staff_key]['other_contact_No'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['other_contact_No'];
					$data_object_kpi[$staff_key]['visa_validity'] = $employees_value[$staff_value['staffid'] . '_' . $current_month]['visa_validity'];
					...
					$data_object_kpi[$staff_key]['designation'] = '';
					$data_object_kpi[$staff_key]['sex'] = '';
					$data_object_kpi[$staff_key]['birthday'] = '';
					$data_object_kpi[$staff_key]['datecreated'] = '';
					$data_object_kpi[$staff_key]['nation'] = '';
					$data_object_kpi[$staff_key]['passport_no'] = '';
					$data_object_kpi[$staff_key]['passport_expiry'] = '';
					$data_object_kpi[$staff_key]['emirates_ID_No'] = '';
					$data_object_kpi[$staff_key]['EID_expiry'] = '';
					$data_object_kpi[$staff_key]['labour_card_No'] = '';
					$data_object_kpi[$staff_key]['phonenumber'] = '';
					$data_object_kpi[$staff_key]['contact_person_home_country'] = '';
					$data_object_kpi[$staff_key]['home_contact_No'] = '';
					$data_object_kpi[$staff_key]['other_contact_person'] = '';
					$data_object_kpi[$staff_key]['other_contact_No'] = '';
					$data_object_kpi[$staff_key]['visa_validity'] = '';
				}
			}
		...
		if ($newquerystring != '') {
			...
			foreach ($staffs as $staff_key => $staff_value) {
				...
				if ($rel_type == 'hr_records') {
					...
					$data_object_kpi[$staff_key]['sex'] = $staff_value['sex'];
					$data_object_kpi[$staff_key]['birthday'] = $staff_value['birthday'];
					$data_object_kpi[$staff_key]['datecreated'] = $staff_value['datecreated'];
					$data_object_kpi[$staff_key]['nation'] = $staff_value['nation'];
					$data_object_kpi[$staff_key]['passport_no'] = $staff_value['passport_no'];
					$data_object_kpi[$staff_key]['passport_expiry'] = $staff_value['passport_expiry'];
					$data_object_kpi[$staff_key]['emirates_ID_No'] = $staff_value['emirates_ID_No'];
					...
					if (isset($employees_value[$staff_value['staffid'] . '_' . $month_filter])) {
						...
						$data_object_kpi[$staff_key]['designation'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['designation'];
						$data_object_kpi[$staff_key]['sex'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['sex'];
						$data_object_kpi[$staff_key]['birthday'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['birthday'];
						$data_object_kpi[$staff_key]['datecreated'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['datecreated'];
						$data_object_kpi[$staff_key]['nation'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['nation'];
						$data_object_kpi[$staff_key]['passport_no'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['passport_no'];
						$data_object_kpi[$staff_key]['passport_expiry'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['passport_expiry'];
						$data_object_kpi[$staff_key]['emirates_ID_No'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['emirates_ID_No'];
						$data_object_kpi[$staff_key]['EID_expiry'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['EID_expiry'];
						$data_object_kpi[$staff_key]['labour_card_No'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['labour_card_No'];
						$data_object_kpi[$staff_key]['phonenumber'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['phonenumber'];
						$data_object_kpi[$staff_key]['contact_person_home_country'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['contact_person_home_country'];
						$data_object_kpi[$staff_key]['home_contact_No'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['home_contact_No'];
						$data_object_kpi[$staff_key]['other_contact_person'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['other_contact_person'];
						$data_object_kpi[$staff_key]['other_contact_No'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['other_contact_No'];
						$data_object_kpi[$staff_key]['visa_validity'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['visa_validity'];
	...
	public function manage_attendance() {
		...
		foreach ($staffs as $staff_key => $staff_value) {
			...
			if (isset($attendances_value[$staff_value['staffid'] . '_' . $current_month])) {
				...
				$data_object_kpi[$staff_key]['overtime_hours'] = $attendances_value[$staff_value['staffid'] . '_' . $current_month]['overtime_hours'];
	...
	public function create_employees_sample_file() {
		...
		foreach ($staffs as $staff_key => $staff_value) {
			...
			if (isset($employees_value[$staff_value['staffid'] . '_' . $month_filter])) {
				...
				$data_object_kpi['designation'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['designation'];
				$data_object_kpi['sex'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['sex'];
				$data_object_kpi['birthday'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['birthday'];
				$data_object_kpi['datecreated'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['datecreated'];
				$data_object_kpi['nation'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['nation'];
				$data_object_kpi['passport_no'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['passport_no'];
				$data_object_kpi['passport_expiry'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['passport_expiry'];
				$data_object_kpi['emirates_ID_No'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['emirates_ID_No'];
				$data_object_kpi['EID_expiry'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['EID_expiry'];
				$data_object_kpi['labour_card_No'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['labour_card_No'];
				$data_object_kpi['phonenumber'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['phonenumber'];
				$data_object_kpi['contact_person_home_country'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['contact_person_home_country'];
				$data_object_kpi['home_contact_No'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['home_contact_No'];
				$data_object_kpi['other_contact_person'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['other_contact_person'];
				$data_object_kpi['other_contact_No'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['other_contact_No'];
				$data_object_kpi['visa_validity'] = $employees_value[$staff_value['staffid'] . '_' . $month_filter]['visa_validity'];
				...
				$data_object_kpi['designation'] = '';
				$data_object_kpi['sex'] = '';
				$data_object_kpi['birthday'] = '';
				$data_object_kpi['datecreated'] = '';
				$data_object_kpi['nation'] = '';
				$data_object_kpi['passport_no'] = '';
				$data_object_kpi['passport_expiry'] = '';
				$data_object_kpi['emirates_ID_No'] = '';
				$data_object_kpi['EID_expiry'] = '';
				$data_object_kpi['labour_card_No'] = '';
				$data_object_kpi['phonenumber'] = '';
				$data_object_kpi['contact_person_home_country'] = '';
				$data_object_kpi['home_contact_No'] = '';
				$data_object_kpi['other_contact_person'] = '';
				$data_object_kpi['other_contact_No'] = '';
				$data_object_kpi['visa_validity'] = '';
		...
		if ($newquerystring != '') {
			...
			foreach ($staffs as $staff_key => $staff_value) {
				...
				if (isset($attendances_value[$staff_value['staffid'] . '_' . $month_filter])) {
					...
					$data_object_kpi[$staff_key]['overtime_hours'] = $attendances_value[$staff_value['staffid'] . '_' . $month_filter]['overtime_hours'];
	...
	public function create_attendance_sample_file() {
		...
		foreach ($staffs as $staff_key => $staff_value) {
			...
			if (isset($attendances_value[$staff_value['staffid'] . '_' . $current_month])) {
				...
				$data_object_kpi['overtime_hours'] = $attendances_value[$staff_value['staffid'] . '_' . $current_month]['overtime_hours'];
				...
				$data_object_kpi['overtime_hours'] = 0;
				$data_object_kpi['id'] = 0;
			...
			if (isset($_FILES['file_csv']['name']) && $_FILES['file_csv']['name'] != '') {
				...
				if (!empty($tmpFilePath) && $tmpFilePath != '') {
					...
					if (move_uploaded_file($tmpFilePath, $newFilePath)) {
						...
						$arr_header['paid_leave'] = 6;
						$arr_header['unpaid_leave'] = 7;
						$arr_header['overtime_hours'] = 8;
						$arr_header['standard_workday'] = 9;
						$arr_header['month'] = 10;
	...
	public function view_payslip_detail($id = "") {
		...
		$send_payslip_to_staff = $this->session->userdata("send_payslip_to_staff");
		if ((isset($send_payslip_to_staff)) && $send_payslip_to_staff != '') {
			$data['send_payslip_to_staff'] = $send_payslip_to_staff;
			$this->session->unset_userdata("send_payslip_to_staff");
		}
	...
	public function create_payslip_file() {
		...
		if ($get_data) {
			...
			foreach ($get_data['payroll_header'] as $key => $value) {
				if (!in_array($payroll_column_key[$key], $payroll_system_columns_dont_format) && $payroll_column_key[$key] != 'account_number' && $payroll_column_key[$key] != 'epf_no') {
			...
			foreach ($get_data['payslip_detail'] as $data_key => $payslip_detail) {
				if(isset($payslip_detail['account_number']) && is_numeric($payslip_detail['account_number'])){
					$payslip_detail['account_number'] = (string)number_format($payslip_detail['account_number'],0,'.','');
				}
				if(isset($payslip_detail['epf_no']) && is_numeric($payslip_detail['epf_no'])){
					$payslip_detail['epf_no'] = (string)number_format($payslip_detail['epf_no'],0,'.','');
				}
			...
			echo json_encode([
				...
				'site_url' => site_url(),
				'staff_id' => get_staff_user_id(),
				'file_url' => HR_PAYROLL_CREATE_PAYSLIP_EXCEL . $filename,
				'filename' => $filename,
			]);
			die;
		}
	 ...
	 * @return [type]     
	 */
	public function payslip_manage_export_pdf1($id)
	{
		if (!$id) {
			show_404();
		}
		...
		foreach ($payslip_details as $payslip_detail) {
			...
			$this->hr_payroll_model->re_save_to_dir($pdf, $employee_name .'_'.date('m-Y', strtotime($payslip_detail['month'])) . '.pdf');
		}
		...
		$this->zip->download($_payslip->payslip_name .'_'. date('m-Y', strtotime($_payslip->payslip_month)). '.zip');
		$this->zip->clear_data();
	}
	...
	public function manage_attendance_timesheet_leaves($month = '') {
		...
		foreach ($attendances as $key => $value) {
			...
			foreach ($value as $hearder_key => $cell_value) {
				...
				if($hearder_key != 'id' && $hearder_key != 'staff_id' && $hearder_key != 'month' && $hearder_key != 'paid_leave' && $hearder_key != 'unpaid_leave' && $hearder_key != 'overtime_hours' && $hearder_key != 'rel_type'){
					if(new_strlen($cell_value) > 0){
						if(preg_match('/^PL:/', $cell_value) && new_strlen($cell_value) < 7){
							$dt_cell_bg[$hearder_key] = '#0c0';

						}elseif(preg_match('/^UPL:/', $cell_value) && new_strlen($cell_value) < 7){
							$dt_cell_bg[$hearder_key] = '#c00';

						}elseif(preg_match('/OT:/', $cell_value) && new_strlen($cell_value) < 7){
							$dt_cell_bg[$hearder_key] = '#2196F3';
					...
					$dt_cell_bg[$hearder_key] = '#c00';
				}elseif($hearder_key == 'overtime_hours' && (float)$cell_value > 0){
					$dt_cell_bg[$hearder_key] = '#2196F3';
				}else{
					$dt_cell_bg[$hearder_key] = '#fff';
				}
		...
		if ($this->input->post()) {
			...
			if (isset($data['id'])) {
				...
				if($this->db->affected_rows() > 0){
					...
					hooks()->do_action('hr_payroll_after_payslip_updated', $data['id']);
					$message = _l('added_successfully', _l('hrp_payslip'));
					set_alert('success', $message);
				}
				redirect(admin_url('hr_payroll/payslip_manage'));
    ...
    public function send_payslip_to_staff() {
    	if ($this->input->is_ajax_request()) {
    		$data = $this->input->get();
    		if ((isset($data)) && $data != '') {

    			$payslip = $this->hr_payroll_model->get_hrp_payslip($data['id']);
    			$payslip_details = $this->hr_payroll_model->get_payslip_detail_by_payslip_id($data['id']);
    			$has_pdf_template = false;
    			$check_payslip_has_pdf_template = check_payslip_has_pdf_template($data['id']);
    			if(is_numeric($check_payslip_has_pdf_template) && is_numeric($check_payslip_has_pdf_template) && $check_payslip_has_pdf_template != 0 ){
    				$has_pdf_template = true;
    			}

    			foreach ($payslip_details as $payslip_detail) {
    				$this->hr_payroll_model->send_payslip_to_staff($payslip, $payslip_detail, true, '', true, $has_pdf_template);
    			}
     ...
     * @return [type] 
     */
    public function table_assign_worker() {
		$this->app->get_table_data(module_views_path('hr_payroll', 'projects/table_assign_worker'));
	}

	/**
	 * get hourly rate by staff
	 * @return [type] 
	 */
	public function get_hourly_rate_by_staff()
    {

    	$hourly_rate = 0;
    	$_staffid = $this->input->post('staff_id');
    	$this->load->model('staff_model');
    	$staff = $this->staff_model->get($_staffid[0]);
    	if($staff){
    ...
    public function delete_assign_worker($id)
    {
        ...
        if(!has_permission('projects', '', 'delete')  && !has_permission('hrp_attendance', '', 'delete')  &&  !is_admin()) {
            access_denied('hrp_assign_workers');
        }
        $success = false;
        $message = '';

        $response = $this->hr_payroll_model->delete_assign_worker($id);
        if($response){
            $success = true;
            $message = _l('deleted', _l('hrp_assign_workers'));
        }
    ...
    /**
     * load assign_worker modal
     * @return [type] 
     */
    public function load_assign_worker_modal()
    {
        if (!$this->input->is_ajax_request()) {
            show_404();
        }
        $data = [];
        $assign_worker_id = $this->input->post('assign_worker_id');
        $data['_project_id'] = $this->input->post('_project_id');
        $data['title'] = _l('hrp_assign_workers');

        if(is_numeric($assign_worker_id) && $assign_worker_id != 0){
            $data['assign_worker'] = $this->hr_payroll_model->get_assign_worker($assign_worker_id);
            $data['title'] = _l('edit');
        }

        $data['staffs']             = $this->staff_model->get('', 'active = 1');

        $this->load->view('projects/assign_worker_modal', $data);
    }
     ...
     * @return [type] 
     */
    public function add_edit_assign_worker()
    {
        $message = '';
        $success = false;
        if ($this->input->post()) {
            ...
            if (is_numeric($id) && $id != 0) {
                ...
                $response = $this->hr_payroll_model->update_assign_worker($data, $id);
                if ($response == true) {
                    $success = true;
                    $message = _l('updated_successfully', _l('hrp_assign_workers'));
                }
                echo json_encode([
                    'success' => $success,
                    'message' => $message,
                    'assign_worker_id' => $id,
                    'url' => admin_url('hr_payroll/manage_attendance'),
                ]);die;
            } else {
                $response = $this->hr_payroll_model->add_assign_worker($data);
                if ($response == true) {
                    $success = true;
                    $message = _l('added_successfully', _l('hrp_assign_workers'));
                }
                echo json_encode([
                    'success' => $success,
                    'message' => $message,
                    'assign_worker_id' => $response,
                    'url' => admin_url('hr_payroll/manage_attendance'),
    ...
    // Tạo job export trong DB (có thể làm bảng riêng export_jobs)
    	$this->db->insert('hrp_export_jobs', [
    		'payslip_id' => $id,
    		'status'     => 'processing',
    		'file_path'  => null,
    	...
    	$message = _l('hrp_Export_PDF_is_running_please_load_in_a_few_minutes');
    	set_alert('success', $message);
    	redirect(admin_url('hr_payroll/payslip_manage'));
     ...
     * @return [type]         
     */
    public function download_payslip($job_id)
    {
    	$job = $this->db->get_where('hrp_export_jobs', ['id' => $job_id])->row();

    	if (!$job || $job->status != 'done' || !file_exists($job->file_path)) {
    		show_error('File chưa sẵn sàng hoặc không tồn tại.');
    	}

    	$this->load->helper('download');
    	force_download($job->file_path, NULL);
    }
