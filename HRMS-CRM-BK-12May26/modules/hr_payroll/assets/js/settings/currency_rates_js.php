<script type="text/javascript">
	...
	function init_currency_rates_table() {
		...
		initDataTable('.table-currency_rates', admin_url + 'hr_payroll/currency_rate_table', [0], [0], fnServerParams, [0, 'desc']);
	}
	...
	function init_currency_rate_logs_table() {
		...
		initDataTable('.table-currency-rate-logs', admin_url + 'hr_payroll/currency_rate_logs_table', [0], [0], _fnServerParams, [0, 'desc']);
	}

	function get_currency_rate(id){
		"use strict";
		var requestURL = admin_url+'hr_payroll/get_currency_rate_online/' + id;
	...
	function get_all_currency_rate(id){
		"use strict";
		var requestURL = admin_url+'hr_payroll/get_all_currency_rate';
		requestGetJSON(requestURL).done(function(response) {
	...
	function edit_currency_rate_modal(id) {
		...
		$("#modal_wrapper").load(admin_url + 'hr_payroll/currency_rate_modal', {
			id: id,
		}, function() {
