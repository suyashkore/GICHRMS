...
<?php if($email_type == 'hr_payroll' || $email_type == ''){ ?>
<div class="col-md-12">
    <h4 class="bold well email-template-heading">
        <?php echo _l('hr_payroll'); ?>
        <?php if ($hasPermissionEdit) { ?>
            <a href="<?php echo admin_url('emails/disable_by_type/hr_payroll'); ?>" class="pull-right mleft5 mright25"><small><?php echo _l('disable_all'); ?></small></a>
            <a href="<?php echo admin_url('emails/enable_by_type/hr_payroll'); ?>" class="pull-right"><small><?php echo _l('enable_all'); ?></small></a>
        <?php } ?>
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach ($hr_payroll_templates as $template) { ?>
                    <tr>
