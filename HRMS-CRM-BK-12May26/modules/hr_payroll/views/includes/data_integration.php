...
<div class="row">
	<div class="col-md-12">
		<h4 class="no-margin font-bold h4-color" ><i class="fa-solid fa-envelope" aria-hidden="true"></i> <?php echo _l('hrp_send_email_to_staff_when_payslip_closing')?></h4>
		<hr class="hr-color" >
	</div>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="form-group">
			<div class="checkbox checkbox-primary">
				<input type="checkbox" id="notify_closing_payslip" name="notify_closing_payslip" <?php if(get_hr_payroll_option('notify_closing_payslip') == 1 ){ echo 'checked';} ?> value="notify_closing_payslip" >
				<label for="notify_closing_payslip"><?php echo _l('hrp_notify_closing_payslip'); ?>
			</label>
		</div>
	</div>
</div>
