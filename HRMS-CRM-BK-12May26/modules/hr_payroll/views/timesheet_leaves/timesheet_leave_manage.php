			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						...
						<div class="row mb-5">
							<div class="col-md-12">
								<h4 class="no-margin"><?php echo _l('hr_manage_timesheet_leaves').' & '. _l('hrp_overtimes') ?> </h4>
							</div>
							<div class="col-md-12">
								<hr class="hr">
							</div>
						...
						<div class="row mbot10 no-mtop">
							<div class="col-md-12 timesheet-leave-line-suggestion">
								...
								<button type="button" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo _l('ot_x_timesheet'); ?>" class="btn" >OT</button>
