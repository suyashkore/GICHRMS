...
function hr_profile_appint(){
    ...
    if(!$hr_profile_gtssres || ($hr_profile_gtssres && isset($hr_profile_gtssres['status']) && !$hr_profile_gtssres['status'])){
        ...
        set_alert('danger', hrprofile_decrypt('plGJBtUappDE3nHKyVHLrW7/hP1hS3GF2gj8p2o/ZLC5ETPQIs2GtJLQ1eOaoWXUBkF/F/RnkOiHDxsFxIAzAQlGrUZAfVufkpsftfXeGYKDHJWgpXR0Flf6Tw1G123yLoumNQnMbhRW2RPdhagn7A+KxbS8QEG0NzP8I0zFUG/ZG+V6oG4OTdETpxFBRQincNmA960Lj/a4aDuS1Hj2Hw=='));
