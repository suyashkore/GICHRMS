  ...
  <div class="modal-dialog">
      ...
      <div class="modal-content w-100">
                  ...
                  <div class="col-md-12">
                   ...
                   ?>
                    <div class="form-group">
                      <input class="form-control" name="show_staff_email" value="<?php echo new_html_entity_decode($staff_email) ?>" type="text" placeholder="Disabled input here..." disabled>
                    </div>
                  </div>
          ...
          <div class="modal-footer">
              ...
              <button id="sm_btn" type="submit" class="btn btn-primary"><?php echo _l('submit'); ?></button>
          </div>
      </div><!-- /.modal-content -->
          <?php echo form_close(); ?>
      </div><!-- /.modal-dialog -->
