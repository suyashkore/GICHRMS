								...
								<h4 class="modal-title pl-3">
									<span class="edit-title"><?php echo _l('hr_job_position_detail'); ?></span>
										...
										<!-- general_info start -->
														...
														<table class="table border table-striped table-margintop">
															<tbody>
																<tr class="project-overview">
																	...
																	<td><?php echo new_html_entity_decode($job_position_general->position_code) ; ?></td>
																</tr>
																<tr class="project-overview">
																	<td class="bold"><?php echo _l('hr_position_name'); ?></td>
																	<td><?php echo new_html_entity_decode($job_position_general->position_name) ; ?></td>
																</tr>
																<tr class="project-overview">
																	<td class="bold"><?php echo _l('hr_job_p_id'); ?></td>
																	<td><?php echo new_html_entity_decode(get_job_name($job_position_general->job_p_id)) ; ?></td>
																</tr>
																<tr class="project-overview">
											...
											<div class=" row ">
												<div class="col-md-12">
													...
													<hr class="hr-color">
													<h5><?php echo new_html_entity_decode($job_position_general->job_position_description) ; ?></h5>
												</div>
											</div>
										...
										<div role="tabpanel" class="tab-pane hide " id="salary_allowance_insurance">
											...
											<input type="hidden" name="job_position_id" value="<?php echo new_html_entity_decode($job_position_id); ?>">
															...
															<div class="col-md-12 contract-expense-al">
																...
																<?php foreach ($salary_form_edit as $salary_key => $salary_value) { ?>
																	...
																	<div id ="contract-expense" class="row">
																		<div class="col-md-5 ">
																			<label for="salary_form[<?php echo new_html_entity_decode($salary_key); ?>]" class="control-label"><?php echo _l('hr_salary_form'); ?></label>
																			<select onchange="OnSelectionChange_salsaryform (this)" name="salary_form[<?php echo new_html_entity_decode($salary_key); ?>]" class="selectpicker" id="salary_form[<?php echo new_html_entity_decode($salary_key); ?>]" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"> 
																				<option value=""></option> 
																				<?php
																				foreach($salary_form as $s){                             
																					?>
																					<option value="<?php echo new_html_entity_decode($s['form_id']); ?>" <?php if(isset($salary_value) && $salary_value['rel_id'] == $s['form_id'] ){echo 'selected';} ?>><?php echo new_html_entity_decode($s['form_name']); ?></option>
																...
																<div id ="contract-expense" class="row">
																	<div class="col-md-5 ">
																		...
																		<select onchange="OnSelectionChange_salsaryform (this)" name="salary_form[0]" class="selectpicker" id="salary_form[0]" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"> 
																			...
																			foreach($salary_form as $s){                             
																				?>
																				<option value="<?php echo new_html_entity_decode($s['form_id']); ?>" <?php if(isset($contracts) && $contracts[0]['salary_form'] == $s['form_id'] ){echo 'selected';} ?>><?php echo new_html_entity_decode($s['form_name']); ?>
																			</option>
																		<?php } ?>
																	</select>
																</div>
													...
													<div class="col-md-12 contract-allowance-type">
														<?php foreach ($salary_allowance as $allowance_key => $allowance_value) { ?>
															...
															<div id ="contract-allowancetype" class="row">
																<div class="col-md-5">
																	<label for="allowance_type[<?php echo new_html_entity_decode($allowance_key) ?>]" class="control-label"><?php echo _l('hr_allowance_type'); ?></label>
																	<select onchange="OnSelectionChange_allowancetype (this)" name="allowance_type[<?php echo new_html_entity_decode($allowance_key) ?>]" class="selectpicker" id="allowance_type[<?php echo new_html_entity_decode($allowance_key) ?>]" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"> 
																		<option value=""></option> 
																		<?php
																		foreach($allowance_type as $s){                             
																			?>
																			<option value="<?php echo new_html_entity_decode($s['type_id']); ?>" <?php if(isset($allowance_value) && $allowance_value['rel_id'] == $s['type_id'] ){echo 'selected';} ?>><?php echo new_html_entity_decode($s['type_name']); ?></option>
														...
														<div id ="contract-allowancetype" class="row">
															...
															<div class="col-md-5">
																...
																<select onchange="OnSelectionChange_allowancetype (this)" name="allowance_type[0]" class="selectpicker" id="allowance_type[0]" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"> 
																	...
																	foreach($allowance_type as $s){                             
																		?>
																		<option value="<?php echo new_html_entity_decode($s['type_id']); ?>" <?php if(isset($contracts) && $contracts[0]['allowance_type'] == $s['type_id'] ){echo 'selected';} ?>><?php echo new_html_entity_decode($s['type_name']); ?></option>
