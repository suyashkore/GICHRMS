...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <div class="checkbox">              
      <input type="checkbox" class="capability" name="timekeeping_enable_valid_ip" id="timekeeping_enable_valid_ip" <?php echo (($timekeeping_enable_valid_ip == 1) ? 'checked' : '') ?> value="1">
      <label for="timekeeping_enable_valid_ip"><?php echo _l('ts_enable_check_valid_ip'); ?></label>
    </div>
