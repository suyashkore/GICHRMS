           ...
           <div class="modal-body">
            <div class="row">
              <div class="col-md-12">
                ...
                $HrStaffId= get_staff_user_id();
                ?>
                <?php if(is_admin() || $HrStaffId == "255"){ ?>
                ...
                <div class="row curr_date_attendance_wrap">
                  <div class="curr_date text-center" id="curr_date_attendance">
                    ...
                    <?php
                    if($allows_updating_check_in_time == 1 || is_admin() || $HrStaffId == "255"){ ?>
                      ...
                      <?php 
                      $attr = [];
                      if($allows_to_choose_an_older_date == 1 || is_admin() || $HrStaffId == "255")
                      {
                ...
                <div class="col-md-12 bottom_co_btn">
                  <div class="bottom_co_btn_item">
                    <?php
                    if($type_check_in_out == '' || $type_check_in_out == 2 || $allows_updating_check_in_time == 1 || is_admin() || $HrStaffId == "255"){
                    if($type_check_in_out == '' ){
                   ...
                   <div class="bottom_co_btn_item">              
                     <?php if($type_check_in_out == 1 || $allows_updating_check_in_time == 1 || is_admin() || $HrStaffId == "255"){
