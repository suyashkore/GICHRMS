                            ...
                            <?php if(isset($rec_campaingn->rec_job_skill)){ ?>
                                <?php if(count($rec_campaingn->rec_job_skill) >0) {?>
                                    <?php foreach ($rec_campaingn->rec_job_skill as $value) {?>
                                        <button type="button" class="btn btn-primary custmargin"><?php echo html_entity_decode($value['skill_name']) ?></button>
                                        <!--<button class="btn project-status-1 application-style"><?php echo html_entity_decode($value['skill_name']) ?></button>-->
