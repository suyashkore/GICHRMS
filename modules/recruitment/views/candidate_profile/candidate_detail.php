           	...
           	<div class="col-md-12">
		        ...
		        <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="detail">
              		...
              		<p class="bold margin-top-15 general-infor-color"><?php echo 'General Information'; //_l('general_infor'); ?></p>
                  	...
                  	<p class="bold other_infor-style"><?php echo 'Other Information'; //_l('other_infor'); ?></p>
...
?>
				    ...
				    <?php } else {?>
              		...
              		<p class="bold other_infor-style"><?php echo 'Educational Qualification'; //_l('literacy'); ?></p>
              		<hr class="other_infor-hr" />
