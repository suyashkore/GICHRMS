<script>
	...
	$(function(){
		...
		<?php if(isset($detail)){ ?>
			var id = <?php echo new_html_entity_decode($detail); ?>;
		...
		initDataTable(table_resignation_procedures,admin_url + 'hr_profile/table_resignation_procedures',[0], [0], StaffServerParams, [1, 'desc']);
