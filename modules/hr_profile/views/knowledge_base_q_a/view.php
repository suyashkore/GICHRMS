            ...
            <div class="col-md-7">
                <div class="panel_s">
                    <div class="panel-body tc-content">
                       <h4 class="bold no-margin"><?php echo new_html_entity_decode($article->subject); ?></h4>
                       <hr class="hr-panel-heading" />
                       <div class="clearfix"></div>
                       <div class="kb-article">
                         <?php echo new_html_entity_decode($article->description); ?>
                       </div>
                  ...
                  <div class="btn-group mtop15 article_useful_buttons" role="group">
                    <input type="hidden" name="articleid" value="<?php echo new_html_entity_decode($article->articleid); ?>">
                  ...
                  <div class="btn-group mtop15 article_useful_buttons pull-right" role="group">
                    <?php if(isset($article->curator) && $article->curator != '' && $article->curator != 0){ ?>
                      <a href="#" onclick="send_mail_support(this);" id="support_<?php echo new_html_entity_decode($article->articleid); ?>" class="btn btn-success " ><?php echo _l('support') ?></a>
                    <?php } ?>
              ...
              <div class="panel-body">
                ...
                <?php foreach($related_articles as $rel_article_article) { ?>
                    <li>
                        ...
                        <a href="<?php echo admin_url('hr_profile/knowledge_base_q_a/view/'.$rel_article_article['slug']); ?>" class="article-heading"><?php echo new_html_entity_decode($rel_article_article['subject']); ?></a>
