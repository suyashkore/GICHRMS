					...
					<div class="panel-body">
						...
						<div class="modal-body">
							...
							<div class="tab-content">
								<!-- start general infor -->
								<div class="row">
								<h5 class="h5-color"><?php echo _l('hrp_general_info'); ?></h5>
								<hr class="hr-color">
								...
								<div class="row">
									...
									<div class="row">
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 table-responsive">
											...
											<?php } ?>
											<div class="contract-preview tc-content<?php if(has_permission('hrp_setting','','edit')){echo ' editable';} ?>"
												>
												<?php
												if((!isset($pdf_payslip_template) || empty($pdf_payslip_template->content) ) && has_permission('hrp_setting','','edit')){
													...
													echo new_html_entity_decode($pdf_payslip_template->content);
												}
												?>
											</div>
										</div>

										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 table-responsive">
						...
						<div class="modal-footer">
							<a href="<?php echo admin_url('hr_payroll/setting?group=pdf_payslip_template'); ?>"  class="btn btn-default mr-2 "><?php echo _l('close'); ?></a>
