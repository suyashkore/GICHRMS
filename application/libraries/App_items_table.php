...
class App_items_table extends App_items_table_template
{
    ...
    public function items()
    {
        ...
        $regularItemWidth  = $this->get_regular_items_width(17);
        ...
        foreach ($this->items as $item) {
             ...
             * Item quantity
             */
            $itemHTML .= '<td align="right" width="' . $regularItemWidth . '%">' . $item['hsn_code'];
            $itemHTML .= '</td>';
            /**
             * Item quantity
             */
    ...
    public function html_headings()
    {
        ...
        $html .= '<th align="right">' . $this->hsn_heading() . '</th>';
    ...
    public function pdf_headings()
    {
        ...
        $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right">' . $this->hsn_heading() . '</th>';
