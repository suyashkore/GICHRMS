...
$route['ClientLogin'] = 'UserApp_Controller/ClientLoginAPI';
$route['GetAllStaff'] = 'UserApp_Controller/GetAllStaffAPI';
$route['GetAllGroup'] = 'UserApp_Controller/GetAllGroupAPI';
$route['LogOut'] = 'UserApp_Controller/LogOutAPI';

$route['SendGroupMsg'] = 'UserApp_Controller/SendGroupMsgAPI';
$route['GetAllGroupMsg'] = 'UserApp_Controller/GetAllGroupMsgAPI';
$route['SendGroupMsgMultiMedia'] = 'UserApp_Controller/SendGroupMsgMultiMediaAPI';
$route['SendMsg'] = 'UserApp_Controller/SendMsgAPI';
$route['GetAllMsg'] = 'UserApp_Controller/GetAllMsgAPI';
$route['SendMsgMultiMedia'] = 'UserApp_Controller/SendMsgMultiMediaAPI';
