            ...
            <div class="inner mtop20 proposal-html-tabs">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane<?php if (! $this->input->get('tab') || $this->input->get('tab') === 'summary') {
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5 style="color:black" class="company-name-formatted">Contact Information</h5>
                            </div>
                        <?php 
                            foreach($ContactsList as $key1=>$val1){
                            ?>
                            <div class="tw-text-normal col-md-12 text-muted proposal-status">
                                <b>Full Name : </b><?php echo $val1["firstname"]." ".$val1["lastname"]?>
                            </div>
                            
                            <div class="clearfix"></div>
                            <div class="tw-text-normal col-md-12 text-muted proposal-status">
                                <b>Email : </b><?php echo $val1["email"]?>
                            </div>
                            
                            <div class="clearfix"></div>
                            <div class="tw-text-normal col-md-12 text-muted proposal-status">
                                <b>Mobile No. : </b><?php echo $val1["phonenumber"]?>
                            </div>
                            <div class="clearfix"></div>
                            <br>
                        <?php } ?>
                ...
                <?php //if (! empty($proposal->signature)) { 
                    foreach($proposalAcceptList as $key=>$val){
                    ?>
                    ...
                    <div class="col-md-7 proposal-proposal-signed-by">
                        <?= e("{$val['acceptance_firstname']} {$val['acceptance_lastname']}"); ?>
                    </div>
                    ...
                    <div class="col-md-7 proposal-proposal-signed-by">
                        <?= e(_d(explode(' ', $val["acceptance_date"])[0])); ?>
                    </div>
                    ...
                    <div class="col-md-12">
                        <img src="<?= site_url('download/preview_image?path=' . protected_file_url_by_path(get_upload_path_by_type('proposal') . $proposal->id . '/' . $val["signature"])); ?>"
