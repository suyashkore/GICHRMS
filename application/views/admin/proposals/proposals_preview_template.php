            ...
            <div class="col-md-9 text-right _buttons proposal_buttons">
                ...
                <div class="btn-group ">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <?php } ?>
                        <?php if (! empty($proposalAcceptList) && staff_can('delete', 'proposals')) { ?>
                        <li>
                        ...
                        ?>
                                <div class="row mtop25">
                                    <div class="col-md-6 col-md-offset-6 text-right">
                                        <div class="bold">
                                            <p class="no-mbot">
                                                <?= _l('contract_signed_by') . ": {$val["acceptance_firstname"]} {$val["acceptance_lastname"]}"?>
                                            </p>
                                            <p class="no-mbot">
                                                <?= _l('proposal_signed_date') . ': ' . _dt($val["acceptance_date"]) ?>
                                            </p>
                                            <p class="no-mbot">
                                                <?= _l('proposal_signed_ip') . ": {$val['acceptance_ip']}"?>
                                            </p>
                                        </div>
                                        <p class="bold">
                                            <?= _l('document_customer_signature_text'); ?>
                                            <?php if (staff_can('delete', 'proposals')) { ?>
                                            <a href="<?= admin_url('proposals/clear_signature/' . $val["id"]); ?>"
                                                data-toggle="tooltip"
