    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-md-4 mtop20">
                ...
                $total_days = (int) (new DateTime(sprintf('%04d-%02d-01', $year, $month)))->format('t');
                ?>
                <div class="calendar">
                    <div class="grid">
            ...
            <div class="col-md-4 mtop20">
                ...
                <div class="calendar">
                    ...
                    <div class="card">
                        ...
                        <?php if (has_permission('hrp_attendance', '', 'view') || has_permission('hrp_attendance', '', 'view_own')): ?>
                        <div class="text-right" style="margin-bottom: 12px;">
                            <a href="<?php echo admin_url('hr_payroll/manage_attendance'); ?>" class="btn btn-info btn-xs">
                                <?php echo _l('hr_manage_attendance'); ?>
                            </a>
                        </div>
                        <?php endif; ?>
